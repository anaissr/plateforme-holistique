...
export default function EspacePatient() {
  ...
  const notesCarnet = [
    {
      date: '20 avril 2026',
      titre: 'Résumé consultation ChatGPT — troubles digestifs',
      ...
      <nav className="flex justify-between items-center px-8 py-5 bg-white shadow-sm">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-medium" style={{ color: '#1c1917' }}>Marie Laurent</p>
              <p className="text-xs" style={{ color: '#a8a29e' }}>Mon espace santé</p>
            </div>
          </div>
        </div>
      </nav>
      ...
      <div className="max-w-5xl mx-auto px-8 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-sm mt-1" style={{ color: '#a8a29e' }}>
              Votre espace personnel Holistia
            </p>
          </div>
          <button
              ...
              <div className="flex flex-col gap-4">
                {rdvPasses.map((rdv) => (
                  <div
                    key={rdv.date}
                    className="bg-white rounded-2xl p-6 flex gap-4 items-start shadow-sm"
                    style={{ border: '1px solid #e7e5e4', opacity: 0.8 }}
                  >
                    <img src={rdv.photo} alt={rdv.praticien} className="w-14 h-14 rounded-2xl object-cover flex-shrink-0" />
                    <div className="flex-1">
                      <p className="font-medium" style={{ color: '#1c1917' }}>{rdv.praticien}</p>
        ...
        {onglet === 'carnet' && (
          <div className="flex flex-col gap-4">
            ...
            >
              <p className="text-sm font-medium mb-3" style={{ color: '#1c1917' }}>
              ...
              />
              <button
                className="mt-3 text-white text-sm px-6 py-2 rounded-xl"
                style={{ backgroundColor: '#6b21a8' }}
              >
                Sauvegarder
              </button>
        ...
        {onglet === 'profil' && (
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm" style={{ border: '1px solid #e7e5e4' }}>
              ...
              <button
                className="mt-4 text-white text-sm px-6 py-3 rounded-2xl"
                style={{ backgroundColor: '#6b21a8' }}
              >
              ...
              <div className="flex flex-col gap-3">
                {[
                  ...
                  >
                    ...
                    <div
                      className="w-10 h-6 rounded-full flex items-center cursor-pointer transition"
                      style={{ backgroundColor: notif.actif ? '#6b21a8' : '#e7e5e4' }}
                    >
                      <div
                        className="w-4 h-4 bg-white rounded-full shadow transition-all"
                        style={{ marginLeft: notif.actif ? '20px' : '2px' }}
                      />
                    </div>
                  </div>
                ))}
