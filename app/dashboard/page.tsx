        ...
        {onglet === 'apercu' && (
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  {patientsProfil.map((p) => (
                    <div key={p.label}>
                      ...
                      <div className="w-full h-2 rounded-full" style={{ backgroundColor: '#f5f3ff' }}>
                        <div className="h-full rounded-full" style={{ width: `${p.pct}%`, backgroundColor: '#6b21a8' }} />
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="bg-white rounded-3xl p-6 shadow-sm" style={{ border: '1px solid #e7e5e4' }}>
                <h2 className="font-medium mb-1" style={{ color: '#1c1917', fontFamily: 'var(--font-lora)' }}>Problématiques les plus traitées</h2>
                <p className="text-xs mb-4" style={{ color: '#a8a29e' }}>Comparer avec la moyenne des naturopathes sur Holistia</p>
                <div className="flex flex-col gap-3">
                  {problematiquesPrincipales.map((p) => (
                    <div key={p.label}>
                      ...
                      <div className="w-full h-2 rounded-full" style={{ backgroundColor: '#f5f3ff' }}>
                        <div className="h-full rounded-full" style={{ width: `${p.pct}%`, backgroundColor: '#a855f7' }} />
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className="rounded-3xl p-6" style={{ background: 'linear-gradient(135deg, #3b0764 0%, #6b21a8 100%)' }}>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <button className="mt-3 text-xs px-4 py-2 rounded-xl font-medium" style={{ backgroundColor: 'rgba(255,255,255,0.2)', color: '#ffffff' }}>
        ...
        {onglet === 'stats' && (
          <div className="flex flex-col gap-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-3xl p-6 shadow-sm" style={{ border: '1px solid #e7e5e4' }}>
                <h2 className="font-medium mb-4" style={{ color: '#1c1917', fontFamily: 'var(--font-lora)' }}>Comparaison avec les naturopathes Holistia</h2>
                <div className="flex flex-col gap-4">
                  {[
                    { label: 'Note moyenne', vous: '4.9', moyenne: '4.6' },
                    { label: 'RDV par mois', vous: '24', moyenne: '18' },
                    { label: 'Taux occupation', vous: '78%', moyenne: '65%' },
                    { label: 'Vues du profil', vous: '142', moyenne: '98' },
                  ].map((stat) => (
                    <div key={stat.label} className="flex items-center justify-between p-3 rounded-xl" style={{ backgroundColor: '#faf9f7' }}>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-medium px-2 py-0.5 rounded-lg" style={{ backgroundColor: '#f0fdf4', color: '#16a34a' }}>
                          Vous: {stat.vous} ↑
                        </span>
                      </div>
                    </div>
